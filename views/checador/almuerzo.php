    ...
    <title>Almuerzo</title>
      ...
      <link rel="icon" type="image/x-icon" href="../../public/img/checador/LOGO2.png" />
       ...
       <?php 
        ...
        $fecha_almuerzoS = $Object -> format("y-m-d h:i:s a");
        $fecha_almuerzoR = $Object -> format("y-m-d h:i:s a");
       ?>
</head>
<body>
                    ...
                    <section class="pt-3">
                            <div class="container px-lg-5 text-center">
                                ...
                                <div class="row gx-lg-5">
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-4">
                                        <div class="card h-100">
                                            <a href=""><img class="card-img-top" src="../../public/img/checador/rotura.png" ></a>
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                    <form action="ingresarFechaAR.php" method="post" accept-charset="utf-8">
                                                        <input type="datetime"  name="fecha_almuerzoS" value="<?= $fecha_almuerzoS ?>">
                                                        <input type="submit"  name="ingresar" value="Buen provecho">
                                                    </form>
                                                    </h4>
                                                </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-4">
                                        <div class="card h-100">
                                            <a href=""><img class="card-img-top" src="../../public/img/checador/problema.png" ></a>
                                                <div class="card-body">
                                                    <h4 class="card-title">
                                                    <form action="ingresarFechaAR.php" method="post" accept-charset="utf-8">
                                                        <input type="datetime"  name="fecha_almuerzoR" value="<?= $fecha_almuerzoR ?>">
                                                        <input type="submit"  name="ingresar" value="Continua trabajando">
                                                    </form>
                                                    </h4>
                                                </div>
                                        </div>
